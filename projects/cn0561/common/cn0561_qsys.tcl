...
set_instance_parameter_value odr_generator {N_PWMS} {3}
...
set_instance_parameter_value odr_generator {PULSE_1_PERIOD} {85}
set_instance_parameter_value odr_generator {PULSE_1_WIDTH} {1}
...
#add_connection spi_clk_pll.outclk0 axi_dmac_0.m_dest_axi_clock
...
add_connection spi_engine_offload_0.if_trigger odr_generator.if_pwm_2
