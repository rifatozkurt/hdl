...
# rx_dco
set_property -dict {PACKAGE_PIN AE27 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_dco_p[3]]  ; ## C22  FMC_LA18_CC_P  IO_L14P_T2_SRCC_12
set_property -dict {PACKAGE_PIN AF27 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_dco_n[3]]  ; ## C23  FMC_LA18_CC_N  IO_L14N_T2_SRCC_12
set_property -dict {PACKAGE_PIN AB27 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_dco_p[2]]  ; ## D20  FMC_LA17_CC_P  IO_L11P_T1_SRCC_12
set_property -dict {PACKAGE_PIN AC27 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_dco_n[2]]  ; ## D21  FMC_LA17_CC_N  IO_L11N_T1_SRCC_12
set_property -dict {PACKAGE_PIN AF15 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_dco_p[1]]  ; ## D8   FMC_LA01_CC_P  IO_L14P_T2_SRCC_10
set_property -dict {PACKAGE_PIN AG15 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_dco_n[1]]  ; ## D9   FMC_LA01_CC_N  IO_L14N_T2_SRCC_10
set_property -dict {PACKAGE_PIN AE13 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_dco_p[0]]  ; ## G6   FMC_LA00_CC_P  IO_L11P_T1_SRCC_10
set_property -dict {PACKAGE_PIN AF13 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_dco_n[0]]  ; ## G7   FMC_LA00_CC_N  IO_L11N_T1_SRCC_10

# rx_da
set_property -dict {PACKAGE_PIN AF29 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_da_p[3]]   ; ## G27  FMC_LA25_P     IO_L15P_T2_DQS_12
set_property -dict {PACKAGE_PIN AG29 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_da_n[3]]   ; ## G28  FMC_LA25_N     IO_L15N_T2_DQS_12
set_property -dict {PACKAGE_PIN AH28 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_da_p[2]]   ; ## H25  FMC_LA21_P     IO_L19P_T3_12
set_property -dict {PACKAGE_PIN AH29 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_da_n[2]]   ; ## H26  FMC_LA21_N     IO_L19N_T3_VREF_12
set_property -dict {PACKAGE_PIN AA15 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_da_p[1]]   ; ## H13  FMC_LA07_P     IO_L20P_T3_10
set_property -dict {PACKAGE_PIN AA14 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_da_n[1]]   ; ## H14  FMC_LA07_N     IO_L20N_T3_10
set_property -dict {PACKAGE_PIN AE12 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_da_p[0]]   ; ## H7   FMC_LA02_P     IO_L7P_T1_10
set_property -dict {PACKAGE_PIN AF12 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_da_n[0]]   ; ## H8   FMC_LA02_N     IO_L7N_T1_10

# rx_db
set_property -dict {PACKAGE_PIN AJ30 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_db_p[3]]   ; ## D26  FMC_LA26_P     IO_L20P_T3_12
set_property -dict {PACKAGE_PIN AK30 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_db_n[3]]   ; ## D27  FMC_LA26_N     IO_L20N_T3_12
set_property -dict {PACKAGE_PIN AK27 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_db_p[2]]   ; ## G24  FMC_LA22_P     IO_L22P_T3_12
set_property -dict {PACKAGE_PIN AK28 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_db_n[2]]   ; ## G25  FMC_LA22_N     IO_L22N_T3_12
set_property -dict {PACKAGE_PIN AH14 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_db_p[1]]   ; ## D14  FMC_LA09_P     IO_L8P_T1_10
set_property -dict {PACKAGE_PIN AH13 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_db_n[1]]   ; ## D15  FMC_LA09_N     IO_L8N_T1_10
set_property -dict {PACKAGE_PIN AG12 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_db_p[0]]   ; ## G9   FMC_LA03_P     IO_L10P_T1_10
set_property -dict {PACKAGE_PIN AH12 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_db_n[0]]   ; ## G10  FMC_LA03_N     IO_L10N_T1_10
