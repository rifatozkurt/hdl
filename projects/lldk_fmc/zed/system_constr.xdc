...
# rx_dco
set_property -dict {PACKAGE_PIN D20 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_dco_p[3]]              ; ## C22  FMC_LA18_CC_P  IO_L14P_T2_AD4P_SRCC_35
set_property -dict {PACKAGE_PIN C20 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_dco_n[3]]              ; ## C23  FMC_LA18_CC_N  IO_L14N_T2_AD4N_SRCC_35
set_property -dict {PACKAGE_PIN B19 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_dco_p[2]]              ; ## D20  FMC_LA17_CC_P  IO_L13P_T2_MRCC_35
set_property -dict {PACKAGE_PIN B20 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_dco_n[2]]              ; ## D21  FMC_LA17_CC_N  IO_L13N_T2_MRCC_35
set_property -dict {PACKAGE_PIN N19 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_dco_p[1]]              ; ## D8   FMC_LA01_CC_P  IO_L14P_T2_SRCC_34
set_property -dict {PACKAGE_PIN N20 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_dco_n[1]]              ; ## D9   FMC_LA01_CC_N  IO_L14N_T2_SRCC_34
set_property -dict {PACKAGE_PIN M19 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_dco_p[0]]              ; ## G6   FMC_LA00_CC_P  IO_L13P_T2_MRCC_34
set_property -dict {PACKAGE_PIN M20 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_dco_n[0]]              ; ## G7   FMC_LA00_CC_N  IO_L13N_T2_MRCC_34

# rx_da
set_property -dict {PACKAGE_PIN D22 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_da_p[3]]               ; ## G27  FMC_LA25_P     IO_L16P_T2_35
set_property -dict {PACKAGE_PIN C22 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_da_n[3]]               ; ## G28  FMC_LA25_N     IO_L16N_T2_35
set_property -dict {PACKAGE_PIN E19 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_da_p[2]]               ; ## H25  FMC_LA21_P     IO_L21P_T3_DQS_AD14P_35
set_property -dict {PACKAGE_PIN E20 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_da_n[2]]               ; ## H26  FMC_LA21_N     IO_L21N_T3_DQS_AD14N_35
set_property -dict {PACKAGE_PIN T16 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_da_p[1]]               ; ## H13  FMC_LA07_P     IO_L21P_T3_DQS_34
set_property -dict {PACKAGE_PIN T17 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_da_n[1]]               ; ## H14  FMC_LA07_N     IO_L21N_T3_DQS_34
set_property -dict {PACKAGE_PIN P17 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_da_p[0]]               ; ## H7   FMC_LA02_P     IO_L20P_T3_34
set_property -dict {PACKAGE_PIN P18 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_da_n[0]]               ; ## H8   FMC_LA02_N     IO_L20N_T3_34

# rx_db
set_property -dict {PACKAGE_PIN F18 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_db_p[3]]               ; ## D26  FMC_LA26_P     IO_L5P_T0_AD9P_35
set_property -dict {PACKAGE_PIN E18 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_db_n[3]]               ; ## D27  FMC_LA26_N     IO_L5N_T0_AD9N_35
set_property -dict {PACKAGE_PIN G19 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_db_p[2]]               ; ## G24  FMC_LA22_P     IO_L20P_T3_AD6P_35
set_property -dict {PACKAGE_PIN F19 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_db_n[2]]               ; ## G25  FMC_LA22_N     IO_L20N_T3_AD6N_35
set_property -dict {PACKAGE_PIN R20 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_db_p[1]]               ; ## D14  FMC_LA09_P     IO_L17P_T2_34
set_property -dict {PACKAGE_PIN R21 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_db_n[1]]               ; ## D15  FMC_LA09_N     IO_L17N_T2_34
set_property -dict {PACKAGE_PIN N22 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_db_p[0]]               ; ## G9   FMC_LA03_P     IO_L16P_T2_34
set_property -dict {PACKAGE_PIN P22 IOSTANDARD LVDS_25 DIFF_TERM 1} [get_ports rx_db_n[0]]               ; ## G10  FMC_LA03_N     IO_L16N_T2_34
